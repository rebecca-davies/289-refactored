...
public class SignLink implements Runnable {
    ...
    public static String findcachedir() {
        ...
        return findDir("/289", System.getenv("PROGRAMDATA"), "/var/lib/", System.getenv("user.home") + "/Library/Application Support/", System.getenv("user.home"));
    }

    private static String findDir(final String path, final String... basePaths) {
        for (final String basePath : basePaths) {
            try {
                ...
                final File cacheDir = new File(basePath + path);
