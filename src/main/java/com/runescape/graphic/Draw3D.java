...
public class Draw3D extends Draw2D {
    ...
    public static void method418(byte byte0) {
        try {
            ...
            Draw3D.anIntArray1433 = null;
            Draw3D.anIntArrayArray1435 = null;
            Draw3D.anIntArrayArray1436 = null;
            Draw3D.anIntArray1437 = null;
            Draw3D.anIntArray1439 = null;
            Draw3D.anIntArrayArray1440 = null;
            return;
    ...
    public static void method419(byte byte0) {
        try {
            Draw3D.anIntArray1429 = new int[Draw2D.anInt1371];
            if (byte0 == 3) {
                byte0 = 0;
            } else {
                Draw3D.anInt1415 = 340;
            }
            for (int i = 0; i < Draw2D.anInt1371; i++) {
                Draw3D.anIntArray1429[i] = Draw2D.anInt1370 * i;
            }
            Draw3D.anInt1423 = Draw2D.anInt1370 / 2;
    ...
    public static void method421(boolean flag) {
        try {
            ...
            for (int i = 0; i < 50; i++) {
                Draw3D.anIntArrayArray1436[i] = null;
            }
            return;
        } catch (RuntimeException runtimeexception) {
        ...
        try {
            ...
            if (Draw3D.anIntArrayArray1435 == null) {
                ...
                if (Draw3D.aBoolean1418) {
                    Draw3D.anIntArrayArray1435 = new int[Draw3D.anInt1434][16384];
                } else {
                    Draw3D.anIntArrayArray1435 = new int[Draw3D.anInt1434][0x10000];
                }
                for (int k = 0; k < 50; k++) {
    ...
    public static void method423(FileArchive class47, boolean flag) {
        try {
            ...
            for (int i = 0; i < 50; i++) {
                try {
                    Draw3D.aClass44_Sub3_Sub1_Sub3Array1431[i] = new Image8(class47, String.valueOf(i), 0);
                    if (Draw3D.aBoolean1418 && Draw3D.aClass44_Sub3_Sub1_Sub3Array1431[i].anInt1464 == 128) {
                        Draw3D.aClass44_Sub3_Sub1_Sub3Array1431[i].method448(0);
                    } else {
                        Draw3D.aClass44_Sub3_Sub1_Sub3Array1431[i].method449(9);
                    }
                    Draw3D.anInt1430++;
                } catch (Exception _ex) {
                }
    ...
    public static int method424(int i, int j) {
        try {
            if (Draw3D.anIntArray1433[j] != 0) {
                return Draw3D.anIntArray1433[j];
            }
            int k = 0;
            int l = 0;
            int i1 = 0;
            int j1 = Draw3D.anIntArrayArray1440[j].length;
            for (int k1 = 0; k1 < j1; k1++) {
                k += Draw3D.anIntArrayArray1440[j][k1] >> 16 & 0xff;
                l += Draw3D.anIntArrayArray1440[j][k1] >> 8 & 0xff;
                i1 += Draw3D.anIntArrayArray1440[j][k1] & 0xff;
            }
            int l1 = (k / j1 << 16) + (l / j1 << 8) + i1 / j1;
            l1 = Draw3D.method428(l1, 1.3999999999999999D);
            if (i != 0) {
                Draw3D.aBoolean1417 = !Draw3D.aBoolean1417;
            }
            if (l1 == 0) {
                l1 = 1;
            }
    ...
    public static void method425(int i, int j) {
        try {
            if (Draw3D.anIntArrayArray1436[j] == null) {
                return;
            }
            Draw3D.anIntArrayArray1435[Draw3D.anInt1434++] = Draw3D.anIntArrayArray1436[j];
            if (i < 9 || i > 9) {
                return;
            } else {
                Draw3D.anIntArrayArray1436[j] = null;
                return;
            }
        } catch (RuntimeException runtimeexception) {
    ...
    public static int[] method426(int i) {
        ...
        if (Draw3D.anInt1434 > 0) {
            ...
            int j = 0;
            int k = -1;
            for (int l = 0; l < Draw3D.anInt1430; l++) {
                if (Draw3D.anIntArrayArray1436[l] != null && (Draw3D.anIntArray1437[l] < j || k == -1)) {
                    j = Draw3D.anIntArray1437[l];
                    k = l;
                }
            }
            ai = Draw3D.anIntArrayArray1436[k];
            Draw3D.anIntArrayArray1436[k] = null;
        }
        ...
        try {
            ...
            for (int l = 0; l < 512; l++) {
                ...
                for (int l1 = 0; l1 < 128; l1++) {
                    ...
                    l2 = Draw3D.method428(l2, d);
                    Draw3D.anIntArray1439[j++] = l2;
                }
            }
            for (int i1 = 0; i1 < 50; i1++) {
                if (Draw3D.aClass44_Sub3_Sub1_Sub3Array1431[i1] != null) {
                    ...
                    for (int k1 = 0; k1 < ai.length; k1++) {
                        ...
                        if ((Draw3D.anIntArrayArray1440[i1][k1] & 0xf8f8ff) == 0 && k1 != 0) {
                            Draw3D.anIntArrayArray1440[i1][k1] = 1;
                        }
                    }
                }
            }
    ...
    public static void method429(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2) {
        ...
        if (i <= j && i <= k) {
            if (i >= Draw2D.anInt1373) {
                return;
            }
            if (j > Draw2D.anInt1373) {
                j = Draw2D.anInt1373;
            }
            if (k > Draw2D.anInt1373) {
                k = Draw2D.anInt1373;
            }
            if (j < k) {
                j1 = l <<= 16;
                ...
                if (i != j && j3 < j2 || i == j && j3 > l2) {
                    k -= j;
                    j -= i;
                    for (i = Draw3D.anIntArray1429[i]; --j >= 0; i += Draw2D.anInt1370) {
                        Draw3D.method430(Draw2D.anIntArray1369, i, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                        j1 += j3;
                        l += j2;
                        i2 += k3;
                        k1 += k2;
                    ...
                    while (--k >= 0) {
                        Draw3D
                                .method430(Draw2D.anIntArray1369, i, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                        j1 += j3;
                        i1 += l2;
                        i2 += k3;
                        l1 += i3;
                ...
                j -= i;
                for (i = Draw3D.anIntArray1429[i]; --j >= 0; i += Draw2D.anInt1370) {
                    Draw3D.method430(Draw2D.anIntArray1369, i, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                    j1 += j3;
                    l += j2;
                    i2 += k3;
                    k1 += k2;
                ...
                while (--k >= 0) {
                    Draw3D.method430(Draw2D.anIntArray1369, i, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    j1 += j3;
                    i1 += l2;
                    i2 += k3;
                    l1 += i3;
            ...
            if (i != k && j3 < j2 || i == k && l2 > j2) {
                j -= k;
                k -= i;
                for (i = Draw3D.anIntArray1429[i]; --k >= 0; i += Draw2D.anInt1370) {
                    Draw3D.method430(Draw2D.anIntArray1369, i, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += j3;
                    l += j2;
                    l1 += k3;
                    k1 += k2;
            ...
            k -= i;
            for (i = Draw3D.anIntArray1429[i]; --k >= 0; i += Draw2D.anInt1370) {
                Draw3D.method430(Draw2D.anIntArray1369, i, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += j3;
                l += j2;
                l1 += k3;
                k1 += k2;
        ...
        if (j <= k) {
            ...
            if (k < i) {
                ...
                if (j != k && j2 < l2 || j == k && j2 > j3) {
                    i -= k;
                    k -= j;
                    for (j = Draw3D.anIntArray1429[j]; --k >= 0; j += Draw2D.anInt1370) {
                        Draw3D.method430(Draw2D.anIntArray1369, j, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                        l += j2;
                        i1 += l2;
                        k1 += k2;
                        l1 += i3;
                    ...
                    while (--i >= 0) {
                        Draw3D.method430(Draw2D.anIntArray1369, j, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                        l += j2;
                        j1 += j3;
                        k1 += k2;
                        i2 += k3;
                ...
                k -= j;
                for (j = Draw3D.anIntArray1429[j]; --k >= 0; j += Draw2D.anInt1370) {
                    Draw3D.method430(Draw2D.anIntArray1369, j, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    l += j2;
                    i1 += l2;
                    k1 += k2;
                    l1 += i3;
                ...
                while (--i >= 0) {
                    Draw3D.method430(Draw2D.anIntArray1369, j, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                    l += j2;
                    j1 += j3;
                    k1 += k2;
                    i2 += k3;
            ...
            if (j2 < l2) {
                k -= i;
                i -= j;
                for (j = Draw3D.anIntArray1429[j]; --i >= 0; j += Draw2D.anInt1370) {
                    Draw3D.method430(Draw2D.anIntArray1369, j, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                    j1 += j2;
                    i1 += l2;
                    i2 += k2;
                    l1 += i3;
            ...
            i -= j;
            for (j = Draw3D.anIntArray1429[j]; --i >= 0; j += Draw2D.anInt1370) {
                Draw3D.method430(Draw2D.anIntArray1369, j, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                j1 += j2;
                i1 += l2;
                i2 += k2;
                l1 += i3;
        ...
        if (i < j) {
            ...
            if (l2 < j3) {
                j -= i;
                i -= k;
                for (k = Draw3D.anIntArray1429[k]; --i >= 0; k += Draw2D.anInt1370) {
                    Draw3D.method430(Draw2D.anIntArray1369, k, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    i1 += l2;
                    j1 += j3;
                    l1 += i3;
                    i2 += k3;
                ...
                while (--j >= 0) {
                    Draw3D.method430(Draw2D.anIntArray1369, k, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += l2;
                    l += j2;
                    l1 += i3;
                    k1 += k2;
            ...
            i -= k;
            for (k = Draw3D.anIntArray1429[k]; --i >= 0; k += Draw2D.anInt1370) {
                Draw3D.method430(Draw2D.anIntArray1369, k, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                i1 += l2;
                j1 += j3;
                l1 += i3;
                i2 += k3;
            ...
            while (--j >= 0) {
                Draw3D.method430(Draw2D.anIntArray1369, k, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += l2;
                l += j2;
                l1 += i3;
                k1 += k2;
        ...
        if (l2 < j3) {
            i -= j;
            j -= k;
            for (k = Draw3D.anIntArray1429[k]; --j >= 0; k += Draw2D.anInt1370) {
                Draw3D.method430(Draw2D.anIntArray1369, k, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                l += l2;
                j1 += j3;
                k1 += i3;
                i2 += k3;
        ...
        j -= k;
        for (k = Draw3D.anIntArray1429[k]; --j >= 0; k += Draw2D.anInt1370) {
            Draw3D.method430(Draw2D.anIntArray1369, k, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
            l += l2;
            j1 += j3;
            k1 += i3;
            i2 += k3;
    ...
    public static void method430(int ai[], int i, int j, int k, int l, int i1, int j1, int k1) {
        if (Draw3D.aBoolean1421) {
            ...
            if (Draw3D.aBoolean1419) {
                ...
                k = i1 - l >> 2;
                if (k > 0) {
                    l1 = (k1 - j1) * Draw3D.anIntArray1425[k] >> 15;
                } else {
                    l1 = 0;
                }
            }
            if (Draw3D.anInt1422 == 0) {
                while (--k >= 0) {
                    j = Draw3D.anIntArray1439[j1 >> 8];
                    j1 += l1;
                    ai[i++] = j;
                    ai[i++] = j;
                    ai[i++] = j;
                ...
                int j2 = Draw3D.anInt1422;
                int l2 = 256 - Draw3D.anInt1422;
                while (--k >= 0) {
                    j = Draw3D.anIntArray1439[j1 >> 8];
                    j1 += l1;
        ...
        if (Draw3D.anInt1422 == 0) {
            do {
                ai[i++] = Draw3D.anIntArray1439[j1 >> 8];
                j1 += i2;
            } while (--k > 0);
            return;
        }
        int k2 = Draw3D.anInt1422;
        int i3 = 256 - Draw3D.anInt1422;
        do {
            j = Draw3D.anIntArray1439[j1 >> 8];
            j1 += i2;
    ...
    public static void method431(int i, int j, int k, int l, int i1, int j1, int k1) {
        ...
        if (i <= j && i <= k) {
            ...
            if (j < k) {
                ...
                if (i != j && j2 < l1 || i == j && j2 > i2) {
                    ...
                    j -= i;
                    for (i = Draw3D.anIntArray1429[i]; --j >= 0; i += Draw2D.anInt1370) {
                        Draw3D.method432(Draw2D.anIntArray1369, i, k1, 0, j1 >> 16, l >> 16);
                        j1 += j2;
                        l += l1;
                    }
                    while (--k >= 0) {
                        Draw3D.method432(Draw2D.anIntArray1369, i, k1, 0, j1 >> 16, i1 >> 16);
                        j1 += j2;
                        i1 += i2;
                        i += Draw2D.anInt1370;
                    }
                ...
                j -= i;
                for (i = Draw3D.anIntArray1429[i]; --j >= 0; i += Draw2D.anInt1370) {
                    Draw3D.method432(Draw2D.anIntArray1369, i, k1, 0, l >> 16, j1 >> 16);
                    j1 += j2;
                    l += l1;
                }
                while (--k >= 0) {
                    Draw3D.method432(Draw2D.anIntArray1369, i, k1, 0, i1 >> 16, j1 >> 16);
                    j1 += j2;
                    i1 += i2;
                    i += Draw2D.anInt1370;
                }
            ...
            if (i != k && j2 < l1 || i == k && i2 > l1) {
                ...
                k -= i;
                for (i = Draw3D.anIntArray1429[i]; --k >= 0; i += Draw2D.anInt1370) {
                    Draw3D.method432(Draw2D.anIntArray1369, i, k1, 0, i1 >> 16, l >> 16);
                    i1 += j2;
                    l += l1;
                }
                while (--j >= 0) {
            ...
            k -= i;
            for (i = Draw3D.anIntArray1429[i]; --k >= 0; i += Draw2D.anInt1370) {
                Draw3D.method432(Draw2D.anIntArray1369, i, k1, 0, l >> 16, i1 >> 16);
                i1 += j2;
                l += l1;
            }
            while (--j >= 0) {
        ...
        if (j <= k) {
            ...
            if (k < i) {
                ...
                if (j != k && l1 < i2 || j == k && l1 > j2) {
                    ...
                    k -= j;
                    for (j = Draw3D.anIntArray1429[j]; --k >= 0; j += Draw2D.anInt1370) {
                        Draw3D.method432(Draw2D.anIntArray1369, j, k1, 0, l >> 16, i1 >> 16);
                        l += l1;
                        i1 += i2;
                    }
                    while (--i >= 0) {
                        Draw3D.method432(Draw2D.anIntArray1369, j, k1, 0, l >> 16, j1 >> 16);
                        l += l1;
                        j1 += j2;
                        j += Draw2D.anInt1370;
                    }
                ...
                k -= j;
                for (j = Draw3D.anIntArray1429[j]; --k >= 0; j += Draw2D.anInt1370) {
                    Draw3D.method432(Draw2D.anIntArray1369, j, k1, 0, i1 >> 16, l >> 16);
                    l += l1;
                    i1 += i2;
                }
                while (--i >= 0) {
                    Draw3D.method432(Draw2D.anIntArray1369, j, k1, 0, j1 >> 16, l >> 16);
                    l += l1;
                    j1 += j2;
                    j += Draw2D.anInt1370;
                }
            ...
            if (l1 < i2) {
                ...
                i -= j;
                for (j = Draw3D.anIntArray1429[j]; --i >= 0; j += Draw2D.anInt1370) {
                    Draw3D.method432(Draw2D.anIntArray1369, j, k1, 0, j1 >> 16, i1 >> 16);
                    j1 += l1;
                    i1 += i2;
                }
                while (--k >= 0) {
            ...
            i -= j;
            for (j = Draw3D.anIntArray1429[j]; --i >= 0; j += Draw2D.anInt1370) {
                Draw3D.method432(Draw2D.anIntArray1369, j, k1, 0, i1 >> 16, j1 >> 16);
                j1 += l1;
                i1 += i2;
            }
            while (--k >= 0) {
        ...
        if (i < j) {
            ...
            if (i2 < j2) {
                ...
                i -= k;
                for (k = Draw3D.anIntArray1429[k]; --i >= 0; k += Draw2D.anInt1370) {
                    Draw3D.method432(Draw2D.anIntArray1369, k, k1, 0, i1 >> 16, j1 >> 16);
                    i1 += i2;
                    j1 += j2;
                }
                while (--j >= 0) {
                    Draw3D.method432(Draw2D.anIntArray1369, k, k1, 0, i1 >> 16, l >> 16);
                    i1 += i2;
                    l += l1;
                    k += Draw2D.anInt1370;
                }
            ...
            i -= k;
            for (k = Draw3D.anIntArray1429[k]; --i >= 0; k += Draw2D.anInt1370) {
                Draw3D.method432(Draw2D.anIntArray1369, k, k1, 0, j1 >> 16, i1 >> 16);
                i1 += i2;
                j1 += j2;
            }
            while (--j >= 0) {
                Draw3D.method432(Draw2D.anIntArray1369, k, k1, 0, l >> 16, i1 >> 16);
                i1 += i2;
                l += l1;
                k += Draw2D.anInt1370;
            }
        ...
        if (i2 < j2) {
            ...
            j -= k;
            for (k = Draw3D.anIntArray1429[k]; --j >= 0; k += Draw2D.anInt1370) {
                Draw3D.method432(Draw2D.anIntArray1369, k, k1, 0, l >> 16, j1 >> 16);
                l += i2;
                j1 += j2;
            }
            while (--i >= 0) {
        ...
        j -= k;
        for (k = Draw3D.anIntArray1429[k]; --j >= 0; k += Draw2D.anInt1370) {
            Draw3D.method432(Draw2D.anIntArray1369, k, k1, 0, j1 >> 16, l >> 16);
            l += i2;
            j1 += j2;
        }
        while (--i >= 0) {
    ...
    public static void method432(int ai[], int i, int j, int k, int l, int i1) {
        ...
        int j1 = Draw3D.anInt1422;
        int k1 = 256 - Draw3D.anInt1422;
    ...
    public static void method433(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2, int j2, int k2,
        ...
        if (i <= j && i <= k) {
            ...
            if (j < k) {
                ...
                if (i != j && i8 < i7 || i == j && i8 > k7) {
                    ...
                    while (--j >= 0) {
                        Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, i, j1 >> 16, l >> 16, i2 >> 8,
                    ...
                    while (--k >= 0) {
                        Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, i, j1 >> 16, i1 >> 16, i2 >> 8,
                ...
                i = Draw3D.anIntArray1429[i];
                while (--j >= 0) {
                    Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, i, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8,
                            l4, k5, j6, i5, l5, k6);
                    j1 += i8;
                    l += i7;
                    i2 += j8;
                ...
                while (--k >= 0) {
                    Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, i, i1 >> 16, j1 >> 16, l1 >> 8,
            ...
            if (i != k && i8 < i7 || i == k && k7 > i7) {
                ...
                i = Draw3D.anIntArray1429[i];
                while (--k >= 0) {
                    Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, i, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8,
                            l4, k5, j6, i5, l5, k6);
                    i1 += i8;
                    l += i7;
                    l1 += j8;
                ...
                while (--j >= 0) {
                    Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, i, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8,
                            l4, k5, j6, i5, l5, k6);
                    j1 += k7;
                    l += i7;
                    i2 += l7;
            ...
            i = Draw3D.anIntArray1429[i];
            while (--k >= 0) {
                Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, i, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4,
                        k5, j6, i5, l5, k6);
                i1 += i8;
                l += i7;
                l1 += j8;
            ...
            while (--j >= 0) {
                Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, i, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4,
                        k5, j6, i5, l5, k6);
                j1 += k7;
                l += i7;
                i2 += l7;
        ...
        if (j <= k) {
            ...
            if (k < i) {
                ...
                if (j != k && i7 < k7 || j == k && i7 > i8) {
                    ...
                    while (--k >= 0) {
                        Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, j, l >> 16, i1 >> 16, k1 >> 8,
                                l1 >> 8, l4, k5, j6, i5, l5, k6);
                        l += i7;
                        i1 += k7;
                        k1 += j7;
                    ...
                    while (--i >= 0) {
                        Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, j, l >> 16, j1 >> 16, k1 >> 8,
                                i2 >> 8, l4, k5, j6, i5, l5, k6);
                        l += i7;
                        j1 += i8;
                        k1 += j7;
                ...
                j = Draw3D.anIntArray1429[j];
                while (--k >= 0) {
                    Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, j, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8,
                            l4, k5, j6, i5, l5, k6);
                    l += i7;
                    i1 += k7;
                    k1 += j7;
                ...
                while (--i >= 0) {
                    Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, j, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8,
                            l4, k5, j6, i5, l5, k6);
                    l += i7;
                    j1 += i8;
                    k1 += j7;
            ...
            if (i7 < k7) {
                ...
                j = Draw3D.anIntArray1429[j];
                while (--i >= 0) {
                    Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, j, j1 >> 16, i1 >> 16, i2 >> 8,
                            l1 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i7;
                    i1 += k7;
                    i2 += j7;
                ...
                while (--k >= 0) {
                    Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, j, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8,
                            l4, k5, j6, i5, l5, k6);
                    l += i8;
                    i1 += k7;
                    k1 += j8;
            ...
            j = Draw3D.anIntArray1429[j];
            while (--i >= 0) {
                Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, j, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8,
                        l4, k5, j6, i5, l5, k6);
                j1 += i7;
                i1 += k7;
                i2 += j7;
            ...
            while (--k >= 0) {
                Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, j, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4,
                        k5, j6, i5, l5, k6);
                l += i8;
                i1 += k7;
                k1 += j8;
        ...
        if (i < j) {
            ...
            if (k7 < i8) {
                ...
                while (--i >= 0) {
                    Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, k, i1 >> 16, j1 >> 16, l1 >> 8,
                            i2 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += k7;
                    j1 += i8;
                    l1 += l7;
                ...
                while (--j >= 0) {
                    Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, k, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8,
                            l4, k5, j6, i5, l5, k6);
                    i1 += k7;
                    l += i7;
                    l1 += l7;
            ...
            k = Draw3D.anIntArray1429[k];
            while (--i >= 0) {
                Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, k, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8,
                        l4, k5, j6, i5, l5, k6);
                i1 += k7;
                j1 += i8;
                l1 += l7;
            ...
            while (--j >= 0) {
                Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, k, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4,
                        k5, j6, i5, l5, k6);
                i1 += k7;
                l += i7;
                l1 += l7;
        ...
        if (k7 < i8) {
            ...
            k = Draw3D.anIntArray1429[k];
            while (--j >= 0) {
                Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, k, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4,
                        k5, j6, i5, l5, k6);
                l += k7;
                j1 += i8;
                k1 += l7;
            ...
            while (--i >= 0) {
                Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, k, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8,
                        l4, k5, j6, i5, l5, k6);
                i1 += i7;
                j1 += i8;
                l1 += j7;
        ...
        k = Draw3D.anIntArray1429[k];
        while (--j >= 0) {
            Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, k, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5,
                    j6, i5, l5, k6);
            l += k7;
            j1 += i8;
            k1 += l7;
        ...
        while (--i >= 0) {
            Draw3D.method434(Draw2D.anIntArray1369, ai, 0, 0, k, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4,
                    k5, j6, i5, l5, k6);
            i1 += i7;
            j1 += i8;
            l1 += j7;
    ...
    public static void method434(int ai[], int ai1[], int i, int j, int k, int l, int i1, int j1, int k1, int l1,
        ...
        if (Draw3D.aBoolean1419) {
            ...
            if (i1 - l > 7) {
                k3 = i1 - l >> 3;
                j3 = (k1 - j1) * Draw3D.anIntArray1425[k3] >> 6;
            } else {
                k3 = 0;
                j3 = 0;
            }
